...
-- ----------------------------
INSERT INTO `we_auto_reply` VALUES ('4', '后台管理', '<a href=\"http://www.songphper.top\">欢迎使用微信后台管理系统</a>', 'text', '1', 'wx7ad4ce9789a311ea', '1', '2018-04-15 21:56:21', '2018-04-15 22:15:26');
...
INSERT INTO `we_auto_reply` VALUES ('7', '百度一下', '<a href=\"www.baidu.com\">百度一下</a>', 'text', '1', 'wx7ad4ce9789a311ea', '1', '2018-04-15 22:06:55', '2018-04-15 22:06:55');
...
CREATE TABLE `we_menu` (
  ...
  `updatetime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='自定义菜单表';
...
INSERT INTO `we_menu` VALUES ('20', 'wxfaa90d8812d78147', '后台管理', 'view', '', 'http://www.songphper.top', '0', '0', '1', '2018-03-11 00:04:39', '2018-03-13 22:14:42');
INSERT INTO `we_menu` VALUES ('22', 'wxfaa90d8812d78147', '2顶级菜单', 'view', '', '', '0', '0', '0', '2018-03-11 00:38:19', '2018-03-13 22:13:29');
INSERT INTO `we_menu` VALUES ('23', 'wxfaa90d8812d78147', '后台管理', 'view', '', 'http://www.songphper.top', '22', '0', '0', '2018-03-11 01:25:00', '2018-03-13 22:13:40');
...
INSERT INTO `we_menu` VALUES ('35', 'wx7ad4ce9789a311ea', '个人中心', 'view', '', '', '0', '0', '1', '2018-04-19 23:21:07', '2018-04-19 23:21:07');
...
CREATE TABLE `we_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='模板消息';
...
INSERT INTO `we_template` VALUES ('35', 'wx7ad4ce9789a311ea', 'M-hMkkXEjBBhZ6l59wRpr6-qDJrfc6Abm3Cy9UQCZGc', '优惠券使用提醒', '', '', '{{first.DATA}} \n优惠券名称：{{keyword1.DATA}} \n领取平台：{{keyword2.DATA}}\n过期时间：{{keyword3.DATA}} \n{{remark.DATA}}', '', '2018-04-15 10:56:08', '2018-04-15 10:56:08', '1');
INSERT INTO `we_template` VALUES ('36', 'wx7ad4ce9789a311ea', 'vsJn3kwFtbjn2yhDuY6v28Ec7x-ffMyv-K9ac52uOaU', '服务到期提醒', '', '', '{{first.DATA}}\n品牌名称：{{keyword1.DATA}}\n服务类型：{{keyword2.DATA}}\n到期时间：{{keyword3.DATA}}\n{{remark.DATA}}', '', '2018-04-15 10:56:08', '2018-04-15 10:56:08', '1');
...
CREATE TABLE `we_wechat_config` (
  ...
  `updatetime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='公众号配置信息表';

-- ----------------------------
-- Records of we_wechat_config
-- ----------------------------
INSERT INTO `we_wechat_config` VALUES ('1', '1,3', '无脸测试平台公众号', 'wx7ad4ce9789a311ea', '67083c9d2d66055bdea6a20b63edcb3c', 'songphper', ' ', '1', '2018-03-09 23:24:17', '2018-04-14 19:10:08');
